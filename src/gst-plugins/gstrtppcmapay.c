...
G_DEFINE_TYPE (GstRtpPcmaPay20, gst_rtp_pcma_pay,
    GST_TYPE_RTP_BASE_AUDIO_PAYLOAD);

static void
gst_rtp_pcma_pay_class_init (GstRtpPcmaPay20Class * klass)
{
...
static void
gst_rtp_pcma_pay_init (GstRtpPcmaPay20 * rtppcmapay)
{
  ...
  g_object_set (rtppcmapay, "min-ptime", DEFAULT_MIN_PTIME, NULL);
}
...
{
  return gst_element_register (plugin, "rtppcmapay20",
      GST_RANK_PRIMARY+1, GST_TYPE_RTP_PCMA_PAY);
}
