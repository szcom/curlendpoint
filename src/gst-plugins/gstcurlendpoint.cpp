...
G_DEFINE_TYPE_WITH_CODE (Gstcurlendpoint, gst_curlendpoint,
                         ...
                         GST_DEBUG_CATEGORY_INIT (gst_curlendpoint_debug_category,
                             PLUGIN_NAME, 0,
                             "debug category for curlendpoint element") );


static GstFlowReturn
gst_curlendpoint_transform_frame_ip (GstVideoFilter *filter,
                                      GstVideoFrame *frame)
{
  return GST_FLOW_OK;
}
...
static void
gst_curlendpoint_init (Gstcurlendpoint *
                        curlendpoint)
{
}
...
gst_curlendpoint_class_init (GstcurlendpointClass *klass)
{
  ...
  video_filter_class->transform_frame_ip =
    GST_DEBUG_FUNCPTR (gst_curlendpoint_transform_frame_ip);
}
